...
noerror1:
	...
	mov bx, Handler
	mov cx, 07CFh ; 7CF=1999 просто число списываемыч байт(символов) 25х80=2000
	mov dx, offset BufIn
	int 21h
...
press:
	...
	cmp di, 07CEh ; 07CE=1998 ну сравнивает счетчик операции с 1998, возможно это надо для проверки кол-ва проверенных знаков
	jna off ; CF=1 тогда будет прыжек
